...
export default async function userAgent(): Promise<string> {
	if (!cachedUserAgents) {
		cachedUserAgents = await fetchUserAgents();
	}
	...
	const fallbacks = {
		...
		darwin: "Mozilla/5.0 (Macintosh; Intel Mac OS X 14_1) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.1 Safari/605.1.15",
		...
		openbsd: "Mozilla/5.0 (X11; U; OpenBSD arm; en-us) AppleWebKit/531.2+ (KHTML, like Gecko) Safari/531.2+ Epiphany/2.30.0",
		...
		haiku: "Mozilla/5.0 (X11; Haiku x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Falkon/23.08.3 QtWebEngine/5.15.17 Chrome/87.0.4280.144 Safari/537.36",
		sunos: "Mozilla/5.0",
		cygwin: "Mozilla/5.0",
